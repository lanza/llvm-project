...
// CIR: cir.func {{.*}} @_ZThn{{[0-9]+}}_N11DeepDerived8method2bEv
...
// CIR: cir.func {{.*}} @_ZThn{{[0-9]+}}_N12EmptyDerived14nonEmptyMethodEv
...
// CIR: cir.func {{.*}} @_ZThn{{[0-9]+}}_N12MultiDerived8method2aEv
// CIR: cir.func {{.*}} @_ZThn{{[0-9]+}}_N12MultiDerived8method2bEv
