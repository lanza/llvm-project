...
// CIR-LABEL: cir.func {{.*}} @_Z22test_polymorphic_basicP4Base
...
// CIR-LABEL: cir.func {{.*}} @_Z14test_referenceR4Base
...
// CIR-LABEL: cir.func {{.*}} @_Z20test_derived_pointerP7Derived
...
// CIR-LABEL: cir.func {{.*}} @_Z14test_const_ptrPK4Base
