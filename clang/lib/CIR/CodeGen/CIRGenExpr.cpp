...
static mlir::Value maybeBuildArrayDecay(mlir::OpBuilder &builder,
                                        ...
                                        mlir::Value arrayPtr,
                                        mlir::Type eltTy) {
  auto arrayPtrTy = mlir::dyn_cast<::mlir::cir::PointerType>(arrayPtr.getType());
  assert(arrayPtrTy && "expected pointer type");
  auto arrayTy = mlir::dyn_cast<::mlir::cir::ArrayType>(arrayPtrTy.getPointee());
...
Address CIRGenFunction::buildArrayToPointerDecay(const Expr *E,
  ...
  auto pointeeTy = mlir::dyn_cast<mlir::cir::ArrayType>(lvalueAddrTy.getPointee());
